...
이 프로젝트는 기존의 와인구독서비스 웹사이트를 새롭게 디자인하고 개발하는 것을 목적으로 합니다. 이전 웹사이트의 사용성, UI/UX 디자인, 성능 개선 등을 고려하여 새로운 디자인과 기능을 추가하였습니다.

웹사이트에서는 와인구독 서비스 이용 방법, 이용 가능한 상품의 종류와 가격, 기존 회원들의 리뷰 등을 제공합니다. 또한, 회원 가입 및 로그인, 구독 신청, 결제 등과 같은 주요 기능을 제공합니다.

모바일 및 데스크톱 화면에서 모두 사용이 가능하도록 반응형 웹 디자인을 적용해보았습니다.
